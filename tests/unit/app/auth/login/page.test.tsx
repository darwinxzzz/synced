...
vi.mock("~/app/(auth)/login/_components/MfaModal", () => ({
  MfaModal: () => null,
}))

vi.mock("~/app/(auth)/login/_components/MfaEnrollPanel", () => ({
  MfaEnrollPanel: () => <div>MFA Enroll</div>,
}))

vi.mock("~/app/(auth)/login/_components/SignupForm", () => ({
  SignupForm: () => <div>Signup Form</div>,
}))

vi.mock("~/app/(auth)/login/_components/auth-atoms", () => ({
  FieldLabel: ({
    children,
    htmlFor,
    className,
