/* eslint-disable @typescript-eslint/prefer-nullish-coalescing, @typescript-eslint/no-base-to-string, @typescript-eslint/restrict-template-expressions, @typescript-eslint/consistent-indexed-object-style, @typescript-eslint/no-unnecessary-type-assertion, @typescript-eslint/no-base-to-string */
"use client";
                  ...
                  >
                    ...
                    {item.value != null && (
                      <span className="text-foreground font-mono font-medium tabular-nums">
                        {(item.value as number | string | undefined)?.toLocaleString?.() ?? String(item.value)}
                      </span>
                    )}
                  </div>
                </>
...
function ChartLegendContent({
  ...
  nameKey,
    ...
    payload?: Array<{ value?: string; color?: string; dataKey?: string | number; type?: string }>;
